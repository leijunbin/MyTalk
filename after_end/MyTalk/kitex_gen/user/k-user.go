...
RequiredFieldNotSetError:
	return offset, thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_RegisterUserRequest[fieldId]))
}
...
func (p *RegisterUserRequest) fastWriteField3(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "phonenumber", thrift.STRING, 3)
...
func (p *RegisterUserRequest) field3Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("phonenumber", thrift.STRING, 3)
...
ReadStructEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return offset, thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_RegisterUserResponse[fieldId]))
}
...
ReadStructEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return offset, thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_LoginUserRequest[fieldId]))
}
...
func (p *LoginUserRequest) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "username_or_phonenumber", thrift.STRING, 1)
	offset += bthrift.Binary.WriteStringNocopy(buf[offset:], binaryWriter, p.UsernameOrPhonenumber)
...
func (p *LoginUserRequest) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("username_or_phonenumber", thrift.STRING, 1)
	l += bthrift.Binary.StringLengthNocopy(p.UsernameOrPhonenumber)
...
ReadStructEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return offset, thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_LoginUserResponse[fieldId]))
}
